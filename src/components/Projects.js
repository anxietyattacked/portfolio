        ...
        {projectData.map(project => (
          ...
          <div className="relative overflow-hidden h-0 p3 col-span-1 md:col-span-5 lg:col-span-3 mb-4 md:mb-0">
            ...
            <div className="md:col-span-4 flex justify-center mt-8">
              <div className="">
              <a className="px-3 py-2 bg-hero rounded-full text-white text-center font-varela font-bold text-lg mr-4" href={project.Link}>Go to Website</a>
              </div>
              <div className="col-span-2">
              <a className="px-3 py-2 bg-hero-alt rounded-full text-white text-center font-varela font-bold text-lg" href={project.ghLink}>Go to Github</a>
              </div>
           </div>
