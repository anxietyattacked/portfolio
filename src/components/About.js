    ...
    return (
        ...
        <section id="about" className="pb-20 bg-gray-100 py-8 px-8 md:px-16 py-4 grid md:grid-cols-2">
          ...
          <div className="md:col-span-2 mb-4">
            <p className="text-xl border-grad bg-black text-white py-8 px-4 md:px-8 lg:px-16 rounded-2xl">My name is Michael Bergerson. I am a frontend web developer with a passion for learning from Olympia, WA. I graduated from Oregon State University with a B.S. in Economics.  My programing journey started after college while I was a family caregiver to my grandmother. Programing became a creative outlet for me. If you can think it, you can build it. That’s what I love about programing.</p>
          </div>
